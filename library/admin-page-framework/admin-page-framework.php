...
/**
 ...
 Generated on 2015-03-05 */
abstract class SampleTDDPlugin_AdminPageFramework_Registry_Base {
    const VERSION = '3.5.5b01';
...
final class SampleTDDPlugin_AdminPageFramework_Registry extends SampleTDDPlugin_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['SampleTDDPlugin_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['SampleTDDPlugin_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('SampleTDDPlugin_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class SampleTDDPlugin_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        SampleTDDPlugin_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (SampleTDDPlugin_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (SampleTDDPlugin_AdminPageFramework_Registry::$sAutoLoaderPath);
        new SampleTDDPlugin_AdminPageFramework_RegisterClasses(empty(SampleTDDPlugin_AdminPageFramework_Registry::$aClassFiles) ? SampleTDDPlugin_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('SampleTDDPlugin_AdminPageFramework_MinifiedVersionHeader', 'SampleTDDPlugin_AdminPageFramework_BeautifiedVersionHeader',),), SampleTDDPlugin_AdminPageFramework_Registry::$aClassFiles);
        SampleTDDPlugin_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('SampleTDDPlugin_AdminPageFramework_InclusionClassFilesHeader');
    }
...
new SampleTDDPlugin_AdminPageFramework_Bootstrap(__FILE__);