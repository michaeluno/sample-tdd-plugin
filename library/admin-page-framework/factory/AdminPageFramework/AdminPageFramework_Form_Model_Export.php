 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Form_Model_Export extends SampleTDDPlugin_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new SampleTDDPlugin_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
