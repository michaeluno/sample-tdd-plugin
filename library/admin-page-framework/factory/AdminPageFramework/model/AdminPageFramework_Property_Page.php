 ...
 */
class SampleTDDPlugin_AdminPageFramework_Property_Page extends SampleTDDPlugin_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
