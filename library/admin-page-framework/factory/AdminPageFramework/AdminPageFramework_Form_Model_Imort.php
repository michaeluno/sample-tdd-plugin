 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Form_Model_Import extends SampleTDDPlugin_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new SampleTDDPlugin_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
