 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Page_View_MetaBox extends SampleTDDPlugin_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aSampleTDDPlugin_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aSampleTDDPlugin_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aSampleTDDPlugin_AdminPageFramework']['bAddedMetaBoxScript'] = true;
