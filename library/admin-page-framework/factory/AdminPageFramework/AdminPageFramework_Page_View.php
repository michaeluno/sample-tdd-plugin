 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Page_View extends SampleTDDPlugin_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new SampleTDDPlugin_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
