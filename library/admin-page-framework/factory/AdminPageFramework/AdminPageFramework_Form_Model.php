 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Form_Model extends SampleTDDPlugin_AdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new SampleTDDPlugin_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
