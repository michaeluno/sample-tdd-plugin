 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $_aFormElementClassNameMap = array('page' => 'SampleTDDPlugin_AdminPageFramework_FormElement_Page', 'network_admin_page' => 'SampleTDDPlugin_AdminPageFramework_FormElement_Page', 'post_meta_box' => 'SampleTDDPlugin_AdminPageFramework_FormElement_Meta', 'page_meta_box' => 'SampleTDDPlugin_AdminPageFramework_FormElement', 'post_type' => 'SampleTDDPlugin_AdminPageFramework_FormElement', 'taxonomy' => 'SampleTDDPlugin_AdminPageFramework_FormElement', 'widget' => 'SampleTDDPlugin_AdminPageFramework_FormElement', 'user_meta' => 'SampleTDDPlugin_AdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'SampleTDDPlugin_AdminPageFramework_Resource_Page', 'network_admin_page' => 'SampleTDDPlugin_AdminPageFramework_Resource_Page', 'post_meta_box' => 'SampleTDDPlugin_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'SampleTDDPlugin_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'SampleTDDPlugin_AdminPageFramework_Resource_PostType', 'taxonomy' => 'SampleTDDPlugin_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'SampleTDDPlugin_AdminPageFramework_Resource_Widget', 'user_meta' => 'SampleTDDPlugin_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'SampleTDDPlugin_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'SampleTDDPlugin_AdminPageFramework_Link_Page', 'network_admin_page' => 'SampleTDDPlugin_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'SampleTDDPlugin_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'SampleTDDPlugin_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'SampleTDDPlugin_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'SampleTDDPlugin_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new SampleTDDPlugin_AdminPageFramework_WPUtility;
        return $this->oUtil;
    }
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new SampleTDDPlugin_AdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = SampleTDDPlugin_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
