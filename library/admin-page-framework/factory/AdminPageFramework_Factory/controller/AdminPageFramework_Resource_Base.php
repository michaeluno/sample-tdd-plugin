 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Resource_Base {
    ...
    protected function _printCommonStyles($sIDPrefix, $sClassName) {
        ...
        $_sStyle = $this->oUtil->addAndApplyFilters($_oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), SampleTDDPlugin_AdminPageFramework_CSS::getDefaultCSS());
        $_sStyle = $this->oUtil->minifyCSS($_sStyle);
        if ($_sStyle) {
            echo "<style type='text/css' id='" . esc_attr($sIDPrefix) . "'>" . $_sStyle . "</style>";
        }
        $_sStyleIE = $this->oUtil->addAndApplyFilters($_oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), SampleTDDPlugin_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->oUtil->addAndApplyFilters($this->oProp->_getCallerObject(), array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), SampleTDDPlugin_AdminPageFramework_Property_Base::$_sDefaultScript);
        if ($_sScript) {
