 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_FormField_Base extends SampleTDDPlugin_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new SampleTDDPlugin_AdminPageFramework_Script_Widget;
        ...
        new SampleTDDPlugin_AdminPageFramework_Script_Utility;
        new SampleTDDPlugin_AdminPageFramework_Script_OptionStorage;
        new SampleTDDPlugin_AdminPageFramework_Script_AttributeUpdator;
        new SampleTDDPlugin_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new SampleTDDPlugin_AdminPageFramework_Script_Sortable;
        new SampleTDDPlugin_AdminPageFramework_Script_RegisterCallback;
    }
