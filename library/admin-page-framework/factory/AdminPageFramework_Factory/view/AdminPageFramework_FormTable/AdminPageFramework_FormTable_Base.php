 ...
 */
class SampleTDDPlugin_AdminPageFramework_FormTable_Base extends SampleTDDPlugin_AdminPageFramework_FormOutput {
    public function __construct($aFieldTypeDefinitions, array $aFieldErrors, $oMsg = null) {
        ...
        $this->oMsg = $oMsg ? $oMsg : SampleTDDPlugin_AdminPageFramework_Message::getInstance();
        $this->_loadScripts();
    }
    ...
    private function _loadScripts() {
        ...
        new SampleTDDPlugin_AdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new SampleTDDPlugin_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new SampleTDDPlugin_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . SampleTDDPlugin_AdminPageFramework_Registry::NAME . ' ' . SampleTDDPlugin_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}