 ...
 */
class SampleTDDPlugin_AdminPageFramework_FieldType_select extends SampleTDDPlugin_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new SampleTDDPlugin_AdminPageFramework_Input_select($aField['attributes']);
