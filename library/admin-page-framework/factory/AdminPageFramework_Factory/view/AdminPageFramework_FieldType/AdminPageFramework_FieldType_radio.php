 ...
 */
class SampleTDDPlugin_AdminPageFramework_FieldType_radio extends SampleTDDPlugin_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new SampleTDDPlugin_AdminPageFramework_Input_radio($aField['attributes']);
