 ...
 */
class SampleTDDPlugin_AdminPageFramework_FieldType_checkbox extends SampleTDDPlugin_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new SampleTDDPlugin_AdminPageFramework_Input_checkbox($aField['attributes']);
