 ...
 */
abstract class SampleTDDPlugin_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aSampleTDDPlugin_AdminPageFramework'] = isset($GLOBALS['aSampleTDDPlugin_AdminPageFramework']) && is_array($GLOBALS['aSampleTDDPlugin_AdminPageFramework']) ? $GLOBALS['aSampleTDDPlugin_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => SampleTDDPlugin_AdminPageFramework_Registry::NAME, 'sURI' => SampleTDDPlugin_AdminPageFramework_Registry::URI, 'sScriptName' => SampleTDDPlugin_AdminPageFramework_Registry::NAME, 'sLibraryName' => SampleTDDPlugin_AdminPageFramework_Registry::NAME, 'sLibraryURI' => SampleTDDPlugin_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => SampleTDDPlugin_AdminPageFramework_Registry::getVersion(), 'sDescription' => SampleTDDPlugin_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => SampleTDDPlugin_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => SampleTDDPlugin_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => SampleTDDPlugin_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => SampleTDDPlugin_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : SampleTDDPlugin_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
