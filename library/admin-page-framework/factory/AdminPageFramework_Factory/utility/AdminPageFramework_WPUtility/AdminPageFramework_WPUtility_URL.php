 ...
 */
class SampleTDDPlugin_AdminPageFramework_WPUtility_URL extends SampleTDDPlugin_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(SampleTDDPlugin_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(SampleTDDPlugin_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = SampleTDDPlugin_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
