...
// $config_file_path = dirname( $_sTestsIncludesDirPath );
$_sTestsIncludesDirPath = $GLOBALS['_sTestsDirPath'] . '/includes';
$config_file_path = $GLOBALS['_sTestsDirPath'];
...
define( 'DIR_TESTDATA', $_sTestsIncludesDirPath . '/../data' );
...
require_once( $_sTestsIncludesDirPath . '/mock-mailer.php' );
$phpmailer = new MockPHPMailer();

system( WP_PHP_BINARY . ' ' . escapeshellarg( $_sTestsIncludesDirPath . '/install.php' ) . ' ' . escapeshellarg( $config_file_path ) . ' ' . $multisite );
...
require $_sTestsIncludesDirPath . '/testcase.php';
require $_sTestsIncludesDirPath . '/testcase-xmlrpc.php';
require $_sTestsIncludesDirPath . '/testcase-ajax.php';
require $_sTestsIncludesDirPath . '/testcase-canonical.php';
require $_sTestsIncludesDirPath . '/exceptions.php';
require $_sTestsIncludesDirPath . '/utils.php';
